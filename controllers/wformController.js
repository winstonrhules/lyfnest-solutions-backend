...
const submissionForm = asyncHandler(async (req, res) => {
 ...
 try{
    ...
    module.exports = {initialVerificationChecks, sendEmailVerification, verifyCode, verifyEmailCode, submissionForm, getallWforms,  getAllNotifs, createNotifs, contactUserByEmail, deleteNotifs, deleteANotifs}
...
//            res.status(201).json({
//              message: 'Whole Life Insurance Form submitted successfully',
//              userEmail: userEmailSent,
//              adminAlert: adminAlertSent,
//              appointment: {
//                slot: appointmentDetails.assignedSlot,
