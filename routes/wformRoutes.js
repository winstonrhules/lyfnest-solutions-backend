...
const {initialVerificationChecks, sendEmailVerification, verifyCode, verifyEmailCode, submissionForm, getallWforms,  getAllNotifs, createNotifs, contactUserByEmail,  deleteNotifs, deleteANotifs} = require('../controllers/wformController');
