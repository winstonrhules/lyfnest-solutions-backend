...
const contactUserByEmail = asyncHandler(async (req, res) => {
  try {
    ...
    if (appointment.formId) {
      formData = await Iform.findById(appointment.formId);
    }
              ...
              <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none;">
                ...
                <div style="background: #f8f9fa; padding: 20px; margin: 20px 0; border-radius: 8px; border-left: 4px solid #4caf50;">
                  ...
                  <ul style="color: #555; margin: 10px 0;">
                    <li><strong>Your Preferred Term:</strong> ${formData.premiumTerms || 'Not specified'}</li>
                    <li><strong>Coverage:</strong> ${formData.coverage || 'Not specified'}</li>
...
module.exports = {initialVerificationChecks, sendEmailVerification, verifyCode, verifyEmailCode, submissionForm, getallIforms, getNotifs, getAllNotifs, createNotifs, deleteNotifs, deleteANotifs, contactUserByEmail};
