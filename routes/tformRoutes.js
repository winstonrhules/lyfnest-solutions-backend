...
const {initialVerificationChecks,  sendEmailVerification, verifyCode, verifyEmailCode, submissionForm, getallTforms, getAllNotifs, createNotifs, contactUserByEmail, deleteNotifs, deleteANotifs} = require('../controllers/tformController');
