...
const submissionForm = asyncHandler(async (req, res) => {
 ...
 try{
    ...
    module.exports = {initialVerificationChecks, sendEmailVerification, verifyCode, verifyEmailCode, submissionForm, getallWforms,  getAllNotifs, createNotifs, deleteNotifs, deleteANotifs}
