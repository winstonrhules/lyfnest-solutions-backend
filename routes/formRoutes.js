...
const {initialVerificationChecks, sendEmailVerification, verifyCode, submissionForm, verifyEmailCode, getallForms,  getAllNotifs, createNotifs, deleteNotifs, deleteANotifs } = require('../controllers/formController');
