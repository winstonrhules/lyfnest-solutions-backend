...
const {initialVerificationChecks, sendEmailVerification, verifyCode, verifyEmailCode, submissionForm, getallFforms, getNotifs, getAllNotifs, createNotifs, deleteNotifs, deleteANotifs} = require('../controllers/fformController');
